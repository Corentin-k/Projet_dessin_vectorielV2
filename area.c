...
void draw_area(Area* area) {
    ...
    for (int i = 0; i < area->nb_shape; i++) {
        ...
        for (int j = 0; j < nb_pixels; j++) {
            ...
            if ((pixel->py - 1 >= 0 && pixel->py - 1 < area->height) &&
                (pixel->px - 1 >= 0 && pixel->px - 1 < area->width)) {

                if (strcmp(area->shapes[i]->color, "red") == 0) {
                    area->mat[pixel->py - 1][pixel->px - 1] = 1;
                } else if (strcmp(area->shapes[i]->color, "black") == 0) {

                    area->mat[pixel->py - 1][pixel->px - 1] = 2;
                } else if (strcmp(area->shapes[i]->color, "green") == 0) {

                    area->mat[pixel->py - 1][pixel->px - 1] = 3;
                } else if (strcmp(area->shapes[i]->color, "yellow") == 0) {

                    area->mat[pixel->py - 1][pixel->px - 1] = 4;
                } else if (strcmp(area->shapes[i]->color, "blue") == 0) {


                    area->mat[pixel->py - 1][pixel->px - 1] = 5;
                }
                else{
                    area->mat[pixel->py - 1][pixel->px - 1] = 6;
                }
    ...
    void print_area(Area *area) {
        ...
        for (int i = 0; i < area->height; i++) {
            for (int j = 0; j < area->width; j++) {
                ...
                } else if (area->mat[i][j] == 1) {

                    printf("\033[31m");
                    printf(" # ");
                } else if (area->mat[i][j] == 2) {
                    printf("\033[30m");
                    printf(" # ");
                } else if (area->mat[i][j] == 3) {
                    printf("\033[32m");
                    printf(" # ");
                } else if (area->mat[i][j] == 4) {
                    printf("\033[33m");
                    printf(" # ");
                } else if (area->mat[i][j] == 5) {
                    printf("\033[34m");
                    printf(" # ");
                }
                else if (area->mat[i][j] == 6) {
